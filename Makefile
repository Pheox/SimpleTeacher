...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile SimpleTeacher.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		src/Dictionary.cc \
		src/Lexicon.cc \
		src/Word.cc moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		Dictionary.o \
		Lexicon.o \
...
$(TARGET): ui_mainwindow.h ui_main.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: SimpleTeacher.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile SimpleTeacher.pro
...
dist: 
	@test -d .tmp/SimpleTeacher1.0.0 || mkdir -p .tmp/SimpleTeacher1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/SimpleTeacher1.0.0/ && $(COPY_FILE) --parents mainwindow.h src/Dictionary.h src/Lexicon.h src/Word.h .tmp/SimpleTeacher1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp src/Dictionary.cc src/Lexicon.cc src/Word.cc .tmp/SimpleTeacher1.0.0/ && $(COPY_FILE) --parents mainwindow.ui main.ui .tmp/SimpleTeacher1.0.0/ && (cd `dirname .tmp/SimpleTeacher1.0.0` && $(TAR) SimpleTeacher1.0.0.tar SimpleTeacher1.0.0 && $(COMPRESS) SimpleTeacher1.0.0.tar) && $(MOVE) `dirname .tmp/SimpleTeacher1.0.0`/SimpleTeacher1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/SimpleTeacher1.0.0
...
moc_mainwindow.cpp: /usr/include/qt5/QtCore/QtCore \
...
compiler_uic_make_all: ui_mainwindow.h ui_main.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_main.h
...
main.o: main.cpp src/Dictionary.h \
		src/Lexicon.h \
		src/Word.h \
...
mainwindow.o: mainwindow.cpp /usr/include/qt5/QtCore/QtCore \
		/usr/include/qt5/QtCore/QtCoreDepends \
		/usr/include/qt5/QtCore/qabstractanimation.h \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
...
Dictionary.o: src/Dictionary.cc src/Dictionary.h \
		src/Lexicon.h \
		src/Word.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Dictionary.o src/Dictionary.cc

Lexicon.o: src/Lexicon.cc src/Lexicon.h \
		src/Word.h \
		src/Dictionary.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Lexicon.o src/Lexicon.cc

Word.o: src/Word.cc src/Word.h \
		src/Dictionary.h \
		src/Lexicon.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Word.o src/Word.cc
